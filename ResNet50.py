...
class ResNet50(tf.keras.Model):
    ...
    class ResidualBlock(tf.keras.Model):
        ...
        def __init__(self, name:str, input_shape:tuple, conv1_2_filters: int, conv3_filters: int,
                        ...
                        use_bias: bool=False, skip_connection_stride: int=(1,1)):
            ...
            self.conv1 = kl.Conv2D(filters=conv1_2_filters, kernel_size=(1,1), strides=conv1_stride,
                                    use_bias=use_bias, activation='linear', name=name+'_conv1')
            ...
            self.conv2 = kl.Conv2D(filters=conv1_2_filters, kernel_size=(3,3), strides=conv2_3_stride,
                                    use_bias=use_bias, activation='linear', name=name+'_conv2')
            ...
            self.conv3 = kl.Conv2D(filters=conv3_filters, kernel_size=(1,1), strides=conv2_3_stride,
                                    activation='linear', name=name+'_conv3')
    ...
    def __init__(self, n_classes: int=config.N_CLASSES):
        ...
        self.conv4_1 = self.ResidualBlock(input_shape=(None,14,14,512), conv1_2_filters=256,
                                            conv3_filters=1024, conv1_stride=(2,2),
                                            conv2_3_stride=(1,1), skip_connection_stride=(2,2),
                                            name='conv4_block1')

        self.conv4_2 = self.ResidualBlock(input_shape=(None,14,14,1024), conv1_2_filters=256,
                                            conv3_filters=1024, conv1_stride=(1,1), conv2_3_stride=(1,1),
                                            name='conv4_block2')
        ...
        self.conv5_1 = self.ResidualBlock(input_shape=(None,7,7,1024), conv1_2_filters=512,
                                            conv3_filters=2048, conv1_stride=(2,2),
                                            conv2_3_stride=(1,1), skip_connection_stride=(2,2),
                                            name='conv5_block1')

        self.conv5_2 = self.ResidualBlock(input_shape=(None,7,7,2048), conv1_2_filters=512,
                                            conv3_filters=2048, conv1_stride=(1,1), conv2_3_stride=(1,1),
                                            name='conv5_block2')
